        ...
        data:()=>({
            items:[
                ...
                },
                {
                    ...
                    icon_class:"mdi-comment-text-multiple"
                },
                {
                    text:"Reviews",
                    to:{name:"table",params:{"type":"reviews"}},
                    icon_class:"mdi-podium-gold"

                },
                {
                    text:"Services",
                    to:{name:"table",params:{"type":"services"}},
                    icon_class:"mdi-shape-plus"
                },
                {
                    text:"Solutions",
                    to:{name:"table",params:{"type":"solutions"}},
                    icon_class:"mdi-chart-bar"
                },
                {
                    text:"Features",
                    to:{name:"table",params:{"type":"reasons"}},
                    icon_class:"mdi-google-circles-extended"
                },


                // {
                //     text:"Clients",
                //     to:{name:"table",params:{"type":"clients"}},
